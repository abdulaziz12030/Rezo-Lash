...
const successMessage = `مرحبًا Rezo Lash ✨
  ...
  return (
    <main className="container-luxe py-24">
      <div className="card-luxe mx-auto max-w-2xl p-10 text-center fade-up">
        <p className="text-sm uppercase tracking-[0.25em] text-black/45">Payment Success</p>
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <a href={buildWhatsAppUrl(successMessage)} target="_blank" rel="noreferrer" className="btn-gold">
            تأكيد عبر الواتس
          </a>
        </div>
      </div>
