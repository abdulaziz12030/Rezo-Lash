  ...
  return (
    <main className="container-luxe py-24">
      <div className="card-luxe mx-auto max-w-3xl p-10 text-center fade-up">
        <p className="text-sm uppercase tracking-[0.25em] text-black/45">Booking Sent</p>
        <h1 className="mt-3 text-4xl font-semibold">تم إرسال طلب الحجز بنجاح</h1>
        <p className="mt-4 text-black/65">تم حفظ طلبك في النظام، ويمكنك الآن إرسال تفاصيل الحجز للإدارة عبر الواتساب لتأكيد أسرع.</p>
        ...
        <div className="mt-8 grid gap-3 rounded-3xl border border-black/5 bg-black/[0.02] p-5 text-right text-sm">
          ...
          <Row label="العربون المقترح" value={`${deposit} SAR`} />
        </div>

        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <a href="/" className="btn-primary">العودة للرئيسية</a>
          {adminWhatsApp ? (
            <a href={adminWhatsApp} target="_blank" rel="noreferrer" className="btn-gold">
              إرسال تفاصيل الحجز للإدارة عبر الواتساب
            </a>
          ) : null}
        </div>
      </div>
