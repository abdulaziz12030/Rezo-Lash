export default function Navbar() {
  return (
    <header className="container-luxe py-5">
      <div className="flex items-center justify-between rounded-3xl bg-white/90 px-5 py-4 shadow-luxe backdrop-blur">
        <div>
        ...
        <nav className="hidden items-center gap-5 md:flex">
          ...
          <a href="#why-us" className="text-sm text-black/70 hover:text-black">
            لماذا ريزو
          </a>
