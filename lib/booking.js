...
export const SERVICES = [
  {
    ...
    styleSummary: "مثالية للمظهر الطبيعي اليومي ولمحبّات النعومة.",
    image: "/services/classic.svg",
    supportsRemoval: true,
    supportsLowerLashes: true
  },
  {
    id: "hybrid",
    nameAr: "هايبرد",
    ...
    styleSummary: "كثافة أنيقة ومتوازنة بدون مبالغة.",
  ...
  },
  {
    ...
    styleSummary: "مناسبة لإبراز العين بامتلاء أنيق.",
  ...
  },
  {
    ...
    styleSummary: "لمن تحب الإطلالة البارزة والفخمة.",
  ...
  },
  {
    ...
    deposit: 160,
    duration: 150,
    descriptionAr: "فانات روسية مرتبة بكثافة فاخرة مع رسمة درامية مميزة.",
    descriptionEn: "Dense Russian fans with premium drama.",
    styleSummary: "الخيار المثالي لعاشقات الرسمة الفخمة.",
  ...
  },
  {
    ...
    styleSummary: "مناسبة بعد 2 إلى 3 أسابيع حسب الفراغات.",
  ...
  },
  {
    ...
    deposit: 60,
    duration: 30,
    descriptionAr: "إزالة آمنة ولطيفة للرموش القديمة مع الحفاظ على الرموش الطبيعية.",
    descriptionEn: "Safe professional lash removal.",
    styleSummary: "خدمة مستقلة عند الحاجة فقط.",
    image: "/services/removal.svg",
    supportsRemoval: false,
    supportsLowerLashes: false
  }
];
...
export function calculateLowerLashesPrice(service) {
  if (!service?.supportsLowerLashes) return 0;
